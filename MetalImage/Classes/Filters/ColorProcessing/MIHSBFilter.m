...
- (void)rotateHue:(float)h {
    huerotatemat(hsbMatrix, h);
    [self updateColorMatrix];
}

- (void)adjustSaturation:(float)s {
    saturatemat(hsbMatrix, s);
    [self updateColorMatrix];
}

- (void)adjustBrightness:(float)b {
    cscalemat(hsbMatrix, b, b, b);
    [self updateColorMatrix];
}

- (void)updateColorMatrix {
    matrix_float4x4 colorMatrix = simd_matrix(vector4(hsbMatrix[0][0], hsbMatrix[1][0],hsbMatrix[2][0],hsbMatrix[3][0]),
                                              vector4(hsbMatrix[0][1], hsbMatrix[1][1],hsbMatrix[2][1],hsbMatrix[3][1]),
                                              vector4(hsbMatrix[0][2], hsbMatrix[1][2],hsbMatrix[2][2],hsbMatrix[3][2]),
                                              vector4(hsbMatrix[0][3], hsbMatrix[1][3],hsbMatrix[2][3],hsbMatrix[3][3]));
