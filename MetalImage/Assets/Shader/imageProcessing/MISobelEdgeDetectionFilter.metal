//
//  MISobelEdgeDetectionFilter.metal
//  MetalImage
//
...
fragment half4 MISobelEdgeDetectionFragmentShader(MINearbyTexelVertexData in [[stage_in]],
                                                   ...
                                                   constant float *edgeStrengths [[buffer(0)]])
{
    ...
    half mag = length(half2(h, v)) * edgeStrength;
